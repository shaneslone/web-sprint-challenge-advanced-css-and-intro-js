...
function get20s(arr) {
  ...
  for (let i = 0; i < arr.length; i++) {
    if (
      arr[i].years.split(' ')[0] >= 1900 &&
      arr[i].years.split(' ')[2] <= 2000
    ) {
...
const newArtist = {
  ...
  bio: 'One of the future great web designers of the 21st centery.',
};
